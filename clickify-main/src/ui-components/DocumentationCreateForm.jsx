...
export default function DocumentationCreateForm(props) {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Documentation(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "DocumentationCreateForm")}
      {...rest}
    >
      <SwitchField
        label="Public"
