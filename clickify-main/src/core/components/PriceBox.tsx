...
export const PriceBox: FC<PriceBoxProps> = ({ plan, onClick, isStatic = false }) => {
  ...
  const currentPlan = plan ? features[plan] : features[PlanTypes.BASIC];
  // TODO Perhaps this is wrong, since I feel like this shouldn't be undefinable
